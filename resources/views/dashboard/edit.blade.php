...
<div class="container content">  
  <form method="POST" action="{{route('todo.update', $todo['id'])}}" id="create-form">
    ...
    <fieldset>
        ...
        <textarea name="description" placeholder="Type your descriptions here..." tabindex="5">value="{{ $todo['description'] }}"></textarea>
    </fieldset>
    <fieldset>
        <button type="submit" id="contactus-submit">Submit</button>
    </fieldset>
    <fieldset>
        <a href="/todo/" class="btn-cancel btn-dark btn-lg btn">Cancel</a>
    </fieldset>
