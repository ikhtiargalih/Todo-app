        ...
        <div class="comment d-flex align-items-start justify-content-between">
            <div class="mr-2">
                <!-- <form action="/todo/complated/{{$todo['id']}}" method="POST">
                    @csrf
                    @method('PATCH')
                    <button type="submit" class="fas fa-check" style="background: #10A19D; padding: 8px !important;"></button>
                </form> -->
                <!-- <label class="option">
                    <input type="checkbox">
            ...
            <div class="ml-auto">
                ...
                <form action="{{ route('todo.delete', $todo['id']) }}" method="POST">
                    @csrf
                    {{-- menimpa attribute method="POST" pada form agar menjadi delete, karena di methode route nya menggunakan delete --}}
                    @method('DELETE')
                    {{-- biar action form nya bisa dijalanin, buttonya harus type submit --}}
